"""
【01 基础 / 02】节点链 —— 数据在节点间流动
=====================================
与〔02_状态State/01〕的区别：
  〔02_状态State/01〕  2 个节点，answer_node 只打印、不写入 State
  〔01_基础/02〕  3 个节点，每个节点都有自己负责的字段
...
# ── 1. State：比〔02_状态State/01〕多了一个 word_count 字段 ─────────────────────────────
...
def llm_node(state: State) -> dict:
    """节点1：调用 LLM，写入 answer（和〔02_状态State/01〕完全一样）"""
    response = llm.invoke([
