"""
【05 工具与Agent / 03】create_agent —— 一行代码建好 ReAct Agent
===================================================
〔05_工具与Agent/02〕手动搭了 ReAct Agent：
...
# ── 1. 工具定义（和〔05_工具与Agent/01〕〔05_工具与Agent/02〕一样）─────────────
@tool
...
# ── 2. 一行创建 ReAct Agent ───────────────────────────────────────────────
# 对比〔05_工具与Agent/02〕需要 7 步，现在只需要这一行：
graph = create_agent(llm, tools)

# 需要记忆功能时，传入 checkpointer（和〔06_持久化与记忆/01〕一样）：
...
# ── 说明 ────────────────────────────────────────────────────────────────────
"""
create_agent(model, tools) 内部等价于〔05_工具与Agent/02〕的：
