"""
【10 子图与多Agent / 03】Multi-Agent —— Supervisor 控制多个子 Agent
====================================================
把前面学过的积木拼在一起：
  〔04_控制流Edge/01〕  条件路由        → Supervisor 根据 LLM 决策路由
  〔05_工具与Agent/02〕  ReAct Agent    → 每个子 Agent 内部是完整的工具调用循环
  〔10_子图与多Agent/01〕 子图当节点      → 每个子 Agent 是一个子图
...
# 子图内部结构和 〔05_工具与Agent/02〕 的 ReAct Agent 完全一致，
