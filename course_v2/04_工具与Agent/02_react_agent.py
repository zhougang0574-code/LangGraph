"""
【04 工具与Agent / 02】ReAct Agent —— 工具真正被执行，循环直到结束
====================================================
与〔04_工具与Agent/01〕的区别：
  〔04_工具与Agent/01〕  LLM 声明要调用工具，但工具没有被执行
  〔04_工具与Agent/02〕  工具被自动执行，结果反馈给 LLM，LLM 再决定下一步
...
# ── 3. agent 节点（和〔04_工具与Agent/01〕的 llm_node 一样）──────────────────────────────
