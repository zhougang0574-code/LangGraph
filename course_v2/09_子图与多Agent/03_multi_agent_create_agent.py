"""
【09 子图与多Agent / 03】Multi-Agent 进阶 —— 用 create_agent 替代手写子图
========================================================================
和 〔09_子图与多Agent/02〕 同样是 Supervisor 多 Agent，只换一处实现方式：
  〔09_子图与多Agent/02〕 的数学子 Agent：手写 MathState + ReAct 子图（prepare/agent/tools/finish）
  本课：               直接用 〔04_工具与Agent/03〕 的 create_agent 一行建好子 Agent
...
# ── 说明 ────────────────────────────────────────────────────────────────────
"""
本课 vs 〔09_子图与多Agent/02〕：

  〔09_子图与多Agent/02〕  数学子 Agent = 手写子图（自定义 MathState + ToolNode 循环）
