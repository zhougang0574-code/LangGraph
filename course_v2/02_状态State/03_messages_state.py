"""
【02 状态State / 03】MessagesState —— 内置的消息状态，省掉重复代码
=========================================================
从〔02_状态State/02〕开始，每次定义 State 都要写这一段：
...
从〔02_状态State/02〕到现在，所有用到 messages 的课都可以把 State 定义换成 MessagesState，
代码行数减少，效果完全一样。
"""
